...
export const elementDefinitions: Record<string, any> = {
  heading: {
    ...
    controls: [
      ...
      { id: 'margin', label: 'MARGIN', tab: 'design', group: 'Spacing', type: 'spacing' },
      // Design tab - Border
  ...
  iconElement: {
    ...
    controls: [
      ...
      { id: 'source', label: 'Source', tab: 'content', group: 'Content', type: 'select', responsive: false, default: 'lucide', options: [
        ...
        { label: 'Ion Icons', value: 'io' },
        { label: 'Bootstrap', value: 'bs' },
        { label: 'Hero Icons', value: 'hi' },
        { label: 'Ant Design', value: 'ai' },
        { label: 'Feather', value: 'fi' },
        { label: 'Image', value: 'image' },
      ]},
      { id: 'icon', label: 'Icon', tab: 'content', group: 'Content', type: 'iconPicker', responsive: false, default: null },
      { id: 'reactIcon', label: 'React Icon Name (legacy)', tab: 'content', group: 'Content', type: 'text', responsive: false, default: null },
